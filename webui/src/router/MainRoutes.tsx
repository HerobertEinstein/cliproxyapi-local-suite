...
import { CodexImportHealthPage } from '@/pages/CodexImportHealthPage';
import { LogicalModelGroupsPage } from '@/pages/LogicalModelGroupsPage';
...
const mainRoutes = [
  ...
  { path: '/codex-import-health', element: <CodexImportHealthPage /> },
  { path: '/logical-model-groups', element: <LogicalModelGroupsPage /> },
