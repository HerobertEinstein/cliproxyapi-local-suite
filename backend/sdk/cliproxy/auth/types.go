...
type Auth struct {
	...
	// APIKeyModelAliases stores runtime-only logical/alias -> upstream model mappings for API-key auths.
	APIKeyModelAliases map[string]string `json:"-"`
...
func (a *Auth) Clone() *Auth {
	...
	if len(a.APIKeyModelAliases) > 0 {
		copyAuth.APIKeyModelAliases = cloneStringMap(a.APIKeyModelAliases)
	}
