...
type LogicalModelGroups = internalconfig.LogicalModelGroups
type LogicalModelCurrent = internalconfig.LogicalModelCurrent
type LogicalModelGroup = internalconfig.LogicalModelGroup
type LogicalModelGroupReasoning = internalconfig.LogicalModelGroupReasoning
...
const (
	...
	LogicalModelGroupAliasCurrent         = internalconfig.LogicalModelGroupAliasCurrent
	LogicalModelGroupReasoningModeRequest = internalconfig.LogicalModelGroupReasoningModeRequest
	LogicalModelGroupReasoningModeGroup   = internalconfig.LogicalModelGroupReasoningModeGroup
)
