...
const sidebarIcons: Record<string, ReactNode> = {
  ...
  codexImportHealth: <IconSidebarSystem size={18} />,
  logicalModels: <IconSidebarProviders size={18} />,
...
export function MainLayout() {
  ...
  const navItems = [
    ...
    {
      path: '/codex-import-health',
      label: t('nav.codex_import_health', { defaultValue: 'Provider Health' }),
      icon: sidebarIcons.codexImportHealth
    },
    {
      path: '/logical-model-groups',
      label: t('nav.logical_model_groups', { defaultValue: 'Logical Models' }),
      icon: sidebarIcons.logicalModels
    },
